      ...
      <Card className="flex  flex-row-reverse max-h-36 justify-between">
        <Box className="grow" sx={{ display: "flex", flexDirection: "column" }}>
          ...
          <Box sx={{ display: "flex", alignItems: "center", pl: 1, pb: 1 }}>
            <IconButton aria-label="bookmark" className="border 	border-solid mr-1	">
              {/* {false ? <SkipNextIcon /> : <SkipPreviousIcon />} */}
              <BookmarkAddOutlined />
            </IconButton>
            <IconButton aria-label="Like" className="border mr-1	border-solid 	">
              <ThumbUpOffAltIcon  fontSize=""/>
            </IconButton>
            <IconButton aria-label="dislike" className="border 	border-solid	">
              <ThumbDownOffAltIcon />
            </IconButton>
          </Box>
        </Box>
