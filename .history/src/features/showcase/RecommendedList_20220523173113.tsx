        ...
        <Box className="grow" sx={{ display: "flex", flexDirection: "column" }}>
          <CardContent sx={{ flex: "1 0 auto" }}>
            ...
            <Typography
              ...
              component="div"
            >
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Nemo ex eius accusamus earum nulla modi fugiat? Suscipit deleniti ut saepe, explicabo reprehenderit quas harum architecto, dicta sed accusantium, expedita corrupti
            </Typography>
          </CardContent>
