...
const FeaturesCarousel = (props: Props) => {
  const CustomRightArrow = ({ onClick, ...rest }:ArrowProps) => {
    return <IconButton className="  bg-gray-200 	hover:bg-gray-300 absolute right-3 " onClick={ () => onClick!()} > <KeyboardArrowRightRoundedIcon className="text-black"/> </IconButton>;
  };

  const CustomLeftArrow = ({ onClick, ...rest }:ArrowProps) => {
    return <IconButton className="  bg-gray-200 	hover:bg-gray-300 absolute left-3 " onClick={ () => onClick!()} > <KeyboardArrowLeftRoundedIcon className="text-black"/> </IconButton>;
  };
