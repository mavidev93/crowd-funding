...
const FeaturesCarousel = (props: Props) => {
  const CustomRightArrow = ({ onClick, ...rest }:ArrowProps) => {
    return <IconButton className="  bg-gray-100 	hover:bg-gray-200 absolute right-3 " onClick={ () => onClick!()} > <KeyboardArrowRightRoundedIcon className="text-black"/> </IconButton>;
  };

  const CustomLeftArrow = ({ onClick, ...rest }:ArrowProps) => {
    return <IconButton className="  bg-gray-100 	hover:bg-gray-200 absolute -left-2 " onClick={ () => onClick!()} > <KeyboardArrowLeftRoundedIcon className="text-black"/> </IconButton>;
  };
