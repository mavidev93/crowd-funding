...
const FeaturesCarousel = (props: Props) => {
  ...
  const CustomLeftArrow = ({ onClick, ...rest }:ArrowProps) => {
    return <IconButton className="  bg-gray-200 	hover:bg-gray-200 absolute left-3 " onClick={ () => onClick!()} > <KeyboardArrowLeftRoundedIcon className="text-black"/> </IconButton>;
  };
