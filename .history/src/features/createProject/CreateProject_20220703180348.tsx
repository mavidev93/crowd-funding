...
const client = create({url: "https://ipfs.infura.io:5001/api/v1"});
...
const CreateProject = () => {
  ...
  useEffect(()=>{
    ...
    async function getData(){
      const data = (await axios.get("https://bafybeidbs56jy2inyi2pgjcqx5y7sohp7gqnrbqwaqjhvxruwjrmaxle6y.ipfs.infura-ipfs.io")).data
      console.log(data)
