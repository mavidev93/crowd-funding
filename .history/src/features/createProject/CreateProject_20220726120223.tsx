...
const CreateProject = () => {
  ...
  const [imgSrcAvatar,setImgSrcAvatart]= useState<null|string>(null)
    ...
    if (event.currentTarget.files) {
      ...
      img.addEventListener("load", function () {
        if (img.naturalWidth >= 500) {
          ...
          dispatchNotification({position:'topR',type:"error",message:"incorrect image size"})
          setImgSrc(null)
          event.target.value = ''
          ...
          <div className="mb-4">
            ...
            <div>
              ...
              <input
                ...
                name="photo"
                type="file"
                onChange={handleAvatarPhotoInputChange}
                // value=""
              />
              {imgSrcAvatar && <ImageCrop imgSrc={imgSrcAvatar} aspect={1 / 1} />}
            </div>
          </div>
          <TextInput
            name="fundAmount"
