      ...
      >
        <Form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 mx-6 mt-4">
          ...
          <div className="mb-4">
            ...
            <div>
              <label htmlFor="avatar" className="block back text-sm font-medium text-gray-900 dark:text-gray-300 border-2 p-2 my-2"   ><FileUploadOutlinedIcon/>Upload Project Avatar Square Image</label>
              <input
                id="avatar"
                name="avatar"
                type="file"
