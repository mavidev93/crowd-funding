    ...
    return (
      <Formik
        ...
        validationSchema={Yup.object().shape({
          ...
          fundAmount:Yup.number().typeError('you must specify a number').required("Required!")
        })}
      ...
      >
        {({ errors, touched, isValidating }) => (
          <Form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 mx-6 mt-4">
            ...
            />
            {/* {errors.creator&&touched.creator && <div>{errors.creator}</div>} */}
            <ErrorMessage className="backdrop-blur-md" name="creator"/>
            <div className="mb-4">
              <label
                htmlFor="cryptos"
            ...
            <Field
              ...
              placeholder=""
            />
  {errors.fundAmount&&touched.fundAmount &&<div>{errors.fundAmount}</div>}
            <Field
              name="walletAddress"
              placeholder=""
