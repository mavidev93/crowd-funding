...
const CreateProject = () => {
  ...
  const handleSubmit = async () => {
    ...
    const dataObject ={creator:"",proposal:"",walletAddress:"",projectImgUrl:"",projectAvatarUrl:"",fundAmount:""}
      ...
      >
        <Form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 mx-6 mt-4">
          ...
          <div className="mb-4">
            ...
            <div>
              <label htmlFor="photo" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"  >Project Image for Header</label>
              <input
                id="photo"
                name="photo"
                type="file"
                onChange={handlePhotoInputChange}
                className="block w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help"
              />
              {imgSrc && (
                <ImageCrop
                  imgSrc={imgSrc}
            ...
            <div>
              <label htmlFor="avatar" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"   >Project Avatar Square Image</label>
              <input
                id="avatar"
                name="avatar"
                type="file"
                onChange={handleAvatarImgInputChange}
                className="block w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 hidden" aria-describedby="file_input_help"
              />
              {imgSrcAvatar && (
                <ImageCrop
                  imgSrc={imgSrcAvatar}
