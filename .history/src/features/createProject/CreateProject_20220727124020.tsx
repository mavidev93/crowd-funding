...
const CreateProject = () => {
  ...
  const [imgAvatarCanvas,setImgAvatarCanvas] = useState<HTMLCanvasElement|null>(null)
  //Hooks
  ...
  const handleSubmit = async () => {
    ...
    const imgBlob = imgCanvas?.toBlob(blob=>console.log(blob))
    // const imgAvatarBlob = imgAvatarCanvas?.toBlob
    console.log(`blob is : ${imgBlob}`)
          ...
          <div className="mb-4">
            ...
            <div>
              ...
              <input
                ...
                // value=""
              />
              {imgSrc && <ImageCrop  imgSrc={imgSrc} aspect={3 / 1} setCanvas={setImgCanvas}/>}
            </div>
            <div>
              ...
              <input
                ...
                // value=""
              />
              {imgSrcAvatar && <ImageCrop imgSrc={imgSrcAvatar} aspect={1 / 1} unit="px" initialAspectWidth={200} setCanvas={setImgAvatarCanvas} />}
            </div>
          </div>
          <TextInput
            name="fundAmount"
