...
const navItemsLeft: navItem[] = [
  ...
  },
  {
    ...
    id: nanoid(),
    classNames: `order-2 ${sharedClasses}  `,
    component:<Button className="bg-secondary-color text-white-color shadow-lg hover:bg-secondary-color hover:shadow-sm ">create campaign</Button>,
...
const navItemsCenter: navItem[] = [
  ...
  {
    id: nanoid(),
    classNames: "grow  justify-center order-0  italic md:flex order-0 ",
