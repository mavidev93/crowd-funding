...
const navItemsLeft: navItem[] = [
  {
    name: "You Created",
    id: nanoid(),
    classNames: `order-3 ${sharedClasses} hover:text--primary-color`,
  ...
  },
  {
    ...
    component: (
      <Button className="bg-secondary-color text-white-color shadow-lg hover:bg-secondary-color hover:shadow-sm transition duration-300	 ease-in-out ">
        create campaign
      </Button>
    ),
