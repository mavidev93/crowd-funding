...
const navItemsLeft: navItem[] = [
  ...
  // },
  {
    ...
    id: nanoid(),
    component: <BookmarkBorder className="text-tx-black bg-primary-color-dark " />,
  ...
  },
  {
    name: "create project",
    id: nanoid(),
    classNames: `order-1 ${sharedClasses} bg-primary-color text-white-color shadow-md	rounded-md
