...
const navItemsLeft: navItem[] = [
  ...
  },
  {
    ...
    id: nanoid(),
    classNames: `order-2 ${sharedClasses}  `,
    component:<Button className="bg-secondary-color text-white-color shadow-lg hover:bg-secondary-color hover:shadow-sm transition duration-1000	 ease-in-out ">create campaign</Button>,
