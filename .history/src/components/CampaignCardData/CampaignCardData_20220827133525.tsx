...
import CommonDivider from "../CommonDivider/CommonDivider"
      ...
      <div>
        <Card className="flex  justify-end  flex-row-reverse shadow-none">
          ...
          <CardMedia
            ...
            sx={{ width: 151 }}
            image={
              (campaign.avatarImgPath && createUrl(campaign.avatarImgPath)) || placeHolder
            }
      ...
      <div className="">
        <div className="flex justify-between  items-center w-full 	">
          <p className="text-lime-600 font-bold text-primary-color order-3">
            <span>Total Funded: </span> <span>{campaign.totalAmountFunded}</span>
          </p>
          <p className="text-lime-600 font-bold text-primary-color-dark order-5">
            <span>Goal Amount:</span> <span>{campaign.goalAmount}</span>
          </p>
          <DaysLeft daysLeft={campaign.daysLeft} />
        </div>
        <CommonDivider className="my-3" />
      </div>
    </div>
