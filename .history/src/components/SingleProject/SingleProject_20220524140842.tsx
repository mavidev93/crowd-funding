...
const SingleProject = ({
  ...
  return (
    <div className="my-3 px-2 ">
      <div className="border border-solid border-bdr-gray p-4 w-5/6 mx-auto relative ">
        ...
        <div className="absolute flex flex-col h-full justify-between top-0 -right-4">
          <IconButton aria-label="bookmark" className="bg-white grow">
            <BookmarkAddOutlined fontSize="small" />
          </IconButton>
          <IconButton aria-label="Like" className="bg-white ">
