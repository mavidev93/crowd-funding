  ...
  const createCampJSX = () => {
    return (
      <div className="flex   w-full">
        <div  className=" 	flex items-center pr-3	w-3/12">
          <div>
          <img className="object-fill	"  src="https://images.unsplash.com/photo-1653155864141-57b96ee8216f?crop=entropy&cs=tinysrgb&fm=jpg&ixlib=rb-1.2.1&q=80&raw_url=true&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1127"  />
        ...
        <div className="grow-0	 pl-2">
          ...
          <div>
            ...
            <div className="flex justify-between  items-center  mt-4 grow-0 max-w-fit	w-9/12">
