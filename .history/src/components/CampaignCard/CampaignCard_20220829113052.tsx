...
const CampaignCard = ({ campaignIpfs }: Props) => {
  ...
  const createCampJSX = () => {
    return (
      <>
      <iframe src="https://images.unsplash.com/photo-1653155864141-57b96ee8216f?crop=entropy&cs=tinysrgb&fm=jpg&ixlib=rb-1.2.1&q=80&raw_url=true&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1127" className="aspect-video" />
        <CommonTitle
          text={campaignTitle}
